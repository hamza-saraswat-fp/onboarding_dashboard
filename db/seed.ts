...
const SESSIONS: SeedSession[] = [
  {
    ...
    salesforceData: { company_name: "Acme HVAC", primary_contact: "Ada Lin", sales_segment: "SMB", industry: "HVAC", number_of_employees: "11-20" },
    currentModule: 8,
  ...
  },
  {
    ...
    salesforceData: { company_name: "Blue Pipe", primary_contact: "Ben Ito", sales_segment: "Mid-Market", industry: "Plumbing", number_of_employees: "21-30" },
    currentModule: 8,
    customFormsEnabled: true,
    status: "completed",
  ...
  },
  {
    ...
    salesforceData: { company_name: "Cinder Electric", primary_contact: "Cy Rho", sales_segment: "SMB", industry: "HVAC", number_of_employees: "6-10" },
    currentModule: 8,
    customFormsEnabled: true,
    status: "completed",
  ...
  },
  {
    ...
    salesforceData: { company_name: "Delta Works", primary_contact: "Di Vas", sales_segment: "Enterprise", industry: "Electrical", number_of_employees: "51+" },
    currentModule: 3,
  ...
  },
  {
    ...
    salesforceData: { company_name: "Ember Plumbing", primary_contact: "El Fox", sales_segment: "SMB", industry: "Plumbing", number_of_employees: "3-5" },
    currentModule: 1,
    customFormsEnabled: false,
    status: "in_progress",
  ...
  },
  {
    ...
    salesforceData: { company_name: "Frost Air", primary_contact: "Fi Nam", sales_segment: "Mid-Market", industry: "HVAC", number_of_employees: "31-50" },
    currentModule: 0,
    customFormsEnabled: false,
    status: "in_progress",
  ...
  },
  {
    ...
    salesforceData: { company_name: "Gale Electric", primary_contact: "Gil Roe", sales_segment: "SMB", industry: "Electrical", number_of_employees: "1-2" },
    currentModule: 1,
    customFormsEnabled: false,
    status: "expired",
  ...
  },
  {
    ...
    salesforceData: { company_name: "Hearth Mechanical", primary_contact: "Ha Sun", sales_segment: "Enterprise", industry: "HVAC", number_of_employees: "51+" },
    currentModule: 8,
    customFormsEnabled: true,
